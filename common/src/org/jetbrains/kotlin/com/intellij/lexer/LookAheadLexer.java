...
public abstract class LookAheadLexer extends LexerBase {
	...
	private final IdeaQueue<IElementType> myTypeCache;
	private final IdeaQueue<Integer> myEndOffsetCache;

	public LookAheadLexer(@NotNull Lexer baseLexer, int capacity) {
		myBaseLexer = baseLexer;
		myTypeCache = new IdeaQueue<>(capacity);
		myEndOffsetCache = new IdeaQueue<>(capacity);
	}
